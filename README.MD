...
...,
  customColorScheme: ['purple', 'teal', 'gray', 'gray', 'red', 'red', 'red']
})
```
...
- customColorScheme {LoggerColorScheme}: a color scheme that defines which color should be used for each log level
